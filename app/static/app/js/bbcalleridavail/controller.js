function BBCalleridavailCtrl($scope, $http, $modal) {
  ...
  $scope.updatePstn = function ($data) {
    ...
    bootbox.confirm("Change AllowPSTN to " + s + " ?", function (result) {
      if (result == true) {
...
app.controller('BBCalleridavailCtrl', ['$scope', '$http', '$modal', BBCalleridavailCtrl]);
