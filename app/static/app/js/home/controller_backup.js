function HomeCtrl($scope, $http, $timeout, $modal, $window) {
  ...
  $scope.getCustDetail = function () {
    ...
    var o = {
      accountid: k.accountid == null ? $scope.custid : k.accountid,
      name: u.name,
      address: u.address,
      creditlimit: k.creditlimit,
      creditusage: k.creditusage,
      imaintype: gatewayinfo.maintype == null ? null : gatewayinfo.maintype.imaintype,
      isubtype: gatewayinfo.subtype == null ? null : gatewayinfo.subtype.isubtype,
      igatetype: gatewayinfo.gw == null ? null : gatewayinfo.gw.igatetype,
      iratetype: gatewayinfo.ratetype == null ? null : gatewayinfo.ratetype.iratetype,
      ilang: gatewayinfo.language == null ? null : gatewayinfo.language.id,
      pbxno: gatewayinfo.pbxno,
      MaxCallAppearance: gatewayinfo.MaxCallAppearance,
      ilcrtype: gatewayinfo.lcrtype == null ? null : gatewayinfo.lcrtype.ilcrtype,

      note: x.note,
      wholesalerkey: gatewayinfo.agroup == null ? null : gatewayinfo.agroup.wholesalerkey,
      ...
      postcode: x.postcode,
      acstatus: custinfo.acstatus == null ? null : custinfo.acstatus.id,
      acmanager: x.acmanager,
      usagecategory: custinfo.ucategory,
      pbxmodel: techinfo.pbxmodel,
      supportteam: techinfo.supportteam == null ? null : techinfo.supportteam.teamid,
      technicalnotes: techinfo.technicalnotes,
      sipsubtype: gatewayinfo.sipsubtype == null ? null : gatewayinfo.sipsubtype.sipsubtype,
      siplcrtype: gatewayinfo.siplcrtype == null ? null : gatewayinfo.siplcrtype.siplcrtype,
      iddusagealert: x.iddusagealert,
      iddusagebar: x.iddusagebar,
      mobusagealert: x.mobusagealert,
      mobusagebar: x.mobusagebar,
      stdusagealert: x.stdusagealert,
      stdusagebar: x.stdusagebar
    };
  ...
  $scope.deleteCust_ = function () {
    var o = {
      accountid: $scope.userdetail.accountid
    };
  ...
  $scope.addCust_ = function () {
    ...
    if (o.accountid == null || o.accountid == '' || o.imaintype == null || o.isubtype == null ||
    o.iratetype == null || o.igatetype == null || o.ilang == null || o.ilcrtype == null) {
  ...
  $scope.ok = function () {
    if ($scope.customer != null) {
      $scope.custid = $scope.customer.accountid;
      $scope.modal.hide();
      $scope.loadCust();
      return;
    }
